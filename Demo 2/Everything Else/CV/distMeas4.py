...
#        areaRatio = 204800 / area
        pixels = abs(((top_left[1] - bottom_left[1]) + (top_right[1] - bottom_right[1]))/2)

        distance = 95.816*(pixels)**(-.935)
...
#        d = areaRatio / math.cos(abs(angleRad))
        frame = cv2.putText(frame,str(angle),(150,100),cv2.FONT_HERSHEY_SIMPLEX,3,(255,0,0),3)
        frame = cv2.putText(frame,"degrees",(150,200),cv2.FONT_HERSHEY_SIMPLEX,3,(255,0,0),3)
        frame = cv2.putText(frame,str(distance),(150,300),cv2.FONT_HERSHEY_SIMPLEX,3,(0,255,0),3)
        frame = cv2.putText(frame,"feet",(150,400),cv2.FONT_HERSHEY_SIMPLEX,3,(0,255,0),3)
